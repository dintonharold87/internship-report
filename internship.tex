...
\par In Partial fulfillment of the requirements for the degree of Computer Science of Makerere University Kampala.
\begin{center}
Ainemukama Dinton Harold:\dotfill
\end{center}
\makebox[2.5in]{\hrulefill} \hspace{0.3in}\makebox[1.8in]{\dotfill}\\
Field Supervisor \hspace{1.5in} \makebox[2.1in][r]{ Date:\hrulefill}\\
\vspace{.1in}
\makebox[2.5in]{\hrulefill} \hspace{0.3in}\makebox[1.8in]{\dotfill}\\
Academic Supervisor  \hspace{1.5in} \makebox[1.8in][r]{Date:\hrulefill}\\
   }%
}
\end{titlepage}
\thispagestyle{empty}
...
\par I Ainemukama Dinton Harold of Registration Number 16/U/3020/PS, sincerely declare that the Internship Report is submitted to the partial fulfillment of the internship program during the last two months. Any part of this report has not been reported or copied from any report of the University and others.\\
Approved by:\\
